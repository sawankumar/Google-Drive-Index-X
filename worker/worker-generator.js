...
const jsURL = 'https://github.com/sawankumar/Google-Drive-Index-X/-/raw/master/worker/worker-beta.js';
...
<head>
    ...
    <title>Google Drive Index - Beta</title>
...
<div class="container">
    <br><br>
    <a href="https://github.com/sawankumar/Google-Drive-Index-X"><h3>Google Index Generator - Beta</h3></a>
    <br>
        <div>
            <h3>1. <a
...
<form>
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <center><p>© <span id="year"></span></p></center>
</div>
