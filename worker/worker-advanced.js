...
<head>
  ...
  <script src="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/js/app-advanced.obf.min.js"></script>
...
class googleDrive {
    ...
    async search(origin_keyword, page_token = null, page_index = 0) {
        ...
        params.fields = "nextPageToken, files(id, teamDriveId, name, mimeType, size , modifiedTime)";
